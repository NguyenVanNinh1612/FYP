...
namespace WebBook.ViewModels
{
    public class ProductVM
    {
        ...
        //public ProductVM(int id, string name, string productCode, string description, string detail, int numberOfPage, string author, decimal price, decimal priceSale, int quantity, bool isFeature, bool isHome, bool isHot, bool isSale, int categoryId, int supplierId, string? seoTitle, string? seoDescription, string? seoKeywords)
        //{
        //    Id = id;
        //    Name = name;
        //    ProductCode = productCode;
